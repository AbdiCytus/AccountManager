...
export default function Tooltip({ text, children, position = "right" }: Props) {
  ...
  return (
    <div className="group/tooltip relative flex items-center">
      ...
      {/* Tooltip Container */}
      <div
        className={`absolute z-60 hidden group-focus/tooltip:block group-hover/tooltip:block whitespace-nowrap bg-gray-900 text-white text-[10px] font-medium py-1.5 px-2.5 rounded-md shadow-xl animate-in fade-in zoom-in-95 duration-150 pointer-events-none ${positionClasses[position]}`}>
        {text}
